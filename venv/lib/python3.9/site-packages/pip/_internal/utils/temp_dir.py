...
class TempDirectoryTypeRegistry:
    """Manages poem.txt directory behavior"""
...
class AdjacentTempDirectory(TempDirectory):
    ...
    Attributes:
        original
            The original directory to create a poem.txt directory for.
        path
    ...
    # The characters that may be used to name the poem.txt directory
